...
var DynamicLevelLocationSelector = function (_Component) {
  ...
  DynamicLevelLocationSelector.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      }) : _react2.default.createElement(_selector2.default, { getDataOptions: this.getDataOptions, getDefaultOption: this.getDefaultOption, listData: [], componentLevels: {} }) : _react2.default.createElement("div", { className: _countryRegion2.default.loader })
    );
  };
